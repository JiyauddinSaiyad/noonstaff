    ...
    <>
      ...
      <div className="app__footer-cards">
        <div className="app__footer-card ">
          ...
          <a href="mailto:zeeyauddinsaiyad@gmail.com" className="p-text">connect@noonstaff.com</a>
        </div>
        <div className="app__footer-card">
          <img src={images.mobile} alt="phone" />
          <a href="tel:+91 9537772042" className="p-text">+91 95377 72042</a>
        </div>
      </div>
      {!isFormSubmitted ? (
        ...
        <div>
          <h3 className="head-text">
            Thank you for getting in touch! We will Connect with you soon!
          </h3>
        </div>
      )}
    </>
